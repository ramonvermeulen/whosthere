...
const (
	EventDeviceDiscovered EventType = iota // A device was found
	EventScanStarted                       // A scan cycle started
	EventScanCompleted                     // A scan cycle finished
	EventError                             // An error occurred
	EventEngineStarted                     // Engine started running
